...
static double closeness = -35.0; //zoom
Planet** planets;
...
{
    t = glutGet(GLUT_ELAPSED_TIME) / 100.0; // rotation speed
...
int main(int argc, char *argv[])
{
	...
	// name, x,y,c1,c2,c3,force,distance from sun,size
	planets = new Planet*[9];
	Planet q("sun", 1.0, 0.6, 0.0, 0.0, 0.0, 1.5);        planets[0] = &q;
	Planet a("mercury", 0.5, 0.4, 0.4, 0.8, 2.5, 0.25);   planets[1] = &a;
	Planet s("venus", 0.6, 0.6, 0.2, 0.5, 3.5, 0.30);     planets[2] = &s;
	Planet d("earth", 0.0, 0.0, 0.7, 0.2, 4.5, 0.35);      planets[3] = &d;
	Planet f("mars", 1.0, 0.2, 0.0, 0.15, 5.5, 0.25);     planets[4] = &f;
	Planet z("jupiter", 0.8, 0.6, 0.3, 0.12, 7.0, 0.55);   planets[5] = &z;
	Planet x("saturn", 0.9, 0.8, 0.3, 0.1, 9.5, 0.40);   planets[6] = &x;
	Planet c("uranus", 0.4, 0.4, 1.0, 0.08, 12.0, 0.55);  planets[7] = &c;
	Planet v("neptune", 0.0, 0.0, 0.5, 0.05, 15.0, 0.55); planets[8] = &v;
